...
static const unsigned int gappfl         = 7;   /* gap between floating windows (when relevant) */
...
//	"st", NULL,
  "/home/frank/.local/bin/autostart",
	NULL /* terminate */
};
...
static const Rule clientrules[] = {
	...
	{ .instance = "spterm (w)", .scratchkey = 'w', .flags = Floating, .floatpos = "50% 0% 95% 50%" },
	{ .instance = "spterm (e)", .scratchkey = 'e', .flags = Floating, .floatpos = "50% 100% 95% 50%" },
	{ .instance = "spterm (`)", .scratchkey = '`'},
	...
	{ .instance = "floating", .flags = Floating|Centered },
	{ .class = "Google-chrome",.workspace = "1", .flags = AttachMaster|OnlyModButtons|SwitchWorkspace  },
...
/* dmenu menus */
static const char *tooler[]             = { "~/.local/bin/tooler", NULL };
static const char *clipboard[]          = { "~/.local/bin/clipboard-menu", NULL };
static const char *powermenu[]          = { "~/.local/bin/power-menu", NULL };
static const char *layout[]             = { "~/.local/bin/keyboard-swithcer-menu", NULL };
static const char *apps[]               = { "~/.local/bin/favorites-apps-menu", NULL };
static const char *screenshots[]        = { "~/.local/bin/screenshots-menu", NULL };
...
//	STACKKEYS(AltGr|Shift,                                       stackswap)                            // swap the currently focused client with the nth client in the stack
  ...
  { KeyPress,   0,                            XF86XK_MonBrightnessUp,                  spawn,                  {.v = lightup } },
	...
	{ KeyPress,   Ctrl|Alt,                     XK_t,                                    spawn,                  {.v = tooler } },
	{ KeyPress,   Ctrl|Alt,                     XK_h,                                    spawn,                  {.v = clipboard } },
	{ KeyPress,   Ctrl|Alt,                     XK_x,                                    spawn,                  {.v = powermenu } },
	{ KeyPress,   Ctrl|Alt,                     XK_p,                                    spawn,                  {.v = apps } },
	{ KeyPress,   Ctrl|Alt,                     XK_space,                                spawn,                  {.v = layout } },
