...
static const unsigned int gappfl         = 15;   /* gap between floating windows (when relevant) */
...
static const BarRule barrules[] = {
	...
	{ -1,       1,     0,       0,   0,   0,     BAR_ALIGN_CENTER,       size_pwrl_ifhidfloat,     draw_powerline,          NULL,                     NULL,                     "powerline join" },
...
/* scratchpads */
static const char *spcmd_w[]            = {"w", "alacritty", "--class", "spterm (w)", NULL };
