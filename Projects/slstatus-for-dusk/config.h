...
static const struct arg args[] = {
  ...
  { run_command,    "^c#212123^^b#a7c080^   ^d^ %s",            "/home/frank/.local/bin/volume-manager get",      "6",        2  },
  { temp,           "^c#212123^^b#a7c080^  ^d^ %s°",            "/sys/class/thermal/thermal_zone0/temp",          "5",        30 },
	{ wifi_essid,     "^c#212123^^b#a7c080^   ^d^ %s",            "wlo1",                                           "4",        60 },
	{ wifi_perc,      "%s%%",                                      "wlo1",                                           "3",        60 },
	{ battery_perc,   "^c#212123^^b#a7c080^   ^d^ %s%%",          "BAT0",                                           "2",        30 },
	{ datetime,       "^c#212123^^b#a7c080^   ^d^ %s",            "%H:%M",                                          "1",        1  },
};
