...
static const BarRule barrules[] = {
	...
	{  0,       0,     0,       5,   5,   7,     BAR_ALIGN_LEFT,         size_status,              draw_status,             click_status,             NULL,                     "button" },
	...
	{  0,       0,     0,       5,   5,   2,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "battery" },
	{  0,       0,     0,       5,   5,   6,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "volume" },
	{  0,       0,     0,       5,   5,   5,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "temp" },
	{  0,       0,     0,       5,   5,   3,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "wifi_perc" },
	{  0,       0,     0,       5,   5,   4,     BAR_ALIGN_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "wifi" },
	{  0,       0,     0,       0,   0,   1,     BAR_ALIGN_CENTER,       size_status,              draw_status,             click_status,             NULL,                     "clock" },
};
...
static const char *emojis[]             = { "~/.local/bin/emoji-menu", NULL };
static const char *apps[]               = { "~/.local/bin/apps-menu", NULL };
static const char *colorpicker[]        = { "~/.local/bin/colorpicker", NULL };
...
static Key keys[] = {
  ...
  { KeyPress,   0,                            XF86XK_MonBrightnessUp,                  spawn,                  {.v = lightup } },
	...
	{ KeyPress,   Ctrl|Alt,                     XK_e,                                    spawn,                  {.v = emojis } },
	{ KeyPress,   Ctrl|Alt,                     XK_p,                                    spawn,                  {.v = apps } },
	{ KeyPress,   Ctrl|Alt,                     XK_c,                                    spawn,                  {.v = colorpicker } },
