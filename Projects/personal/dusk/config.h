...
static const unsigned int gappfl         = 13;   /* gap between floating windows (when relevant) */
static const unsigned int smartgaps_fact = 1;   /* smartgaps factor when there is only one client; 0 = no gaps, 3 = 3x outer gaps */
...
static const int horizpadbar             = 8;   /* horizontal (inner) padding for statusbar (increases lrpad) */
static const int vertpadbar              = 3;   /* vertical (inner) padding for statusbar (increases bh, overridden by bar_height) */
...
unsigned int default_alphas[] = { OPAQUE, OPAQUE, OPAQUE }; // 0xd0U for alpha
...
static const Rule clientrules[] = {
	...
	{ .instance = "spterm (`)", .scratchkey = '`', .flags = AttachMaster },
  ...
  { .class = "1Password", .flags = AlwaysOnTop|Floating|Centered },
...
static const BarRule barrules[] = {
  /* monitor  bar    scheme   lpad rpad value  alignment               sizefunc                  drawfunc                 clickfunc                 hoverfunc                 name */
	...
	{ 'A',      0,     5,       5,   5,   0,     BAR_ALIGN_LEFT,         size_ltsymbol,            draw_ltsymbol,           click_ltsymbol,           NULL,                     "layout" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_LEFT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   0,     BAR_ALIGN_RIGHT_RIGHT,       size_status,              draw_status,             click_status,             NULL,                     "status0" },
	{  0,       0,     0,       5,   5,   1,     BAR_ALIGN_RIGHT_RIGHT,  size_status,              draw_status,             click_status,             NULL,                     "status1" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   2,     BAR_ALIGN_RIGHT_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status2" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   3,     BAR_ALIGN_RIGHT_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status3" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   4,     BAR_ALIGN_RIGHT_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status4" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   5,     BAR_ALIGN_RIGHT_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status5" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   6,     BAR_ALIGN_RIGHT_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status6" },
	{ -1,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,         size_powerline,           draw_powerline,          NULL,                     NULL,                    "powerline join" },
	{  0,       0,     0,       5,   5,   7,     BAR_ALIGN_RIGHT_RIGHT,         size_status,              draw_status,             click_status,             NULL,                    "status7" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,         size_powerline,           draw_powerline,          NULL,                     NULL,                    "powerline join" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   8,     BAR_ALIGN_RIGHT_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status8" },
	{  0,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{  0,       0,     0,       5,   5,   9,     BAR_ALIGN_RIGHT_RIGHT,        size_status,              draw_status,             click_status,             NULL,                     "status9" },
	{ -1,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,        size_powerline,           draw_powerline,          NULL,                     NULL,                     "powerline join" },
	...
	{ -1,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_CENTER,       size_pwrl_ifhidfloat,     draw_powerline,          NULL,                     NULL,                     "powerline join" },
	{ -1,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_RIGHT_RIGHT,  size_wintitle_hidden,     draw_wintitle_hidden,    click_wintitle_hidden,    NULL,                     "wintitle_hidden" },
	{ -1,       0,     0,       0,   0,   PWRL,  BAR_ALIGN_LEFT_LEFT,    size_wintitle_floating,   draw_wintitle_floating,  click_wintitle_floating,  NULL,                     "wintitle_floating" },
};
...
static const WorkspaceRule wsrules[] = {
	...
	{  "1",   0,       1,       3,       -1,    -1,       -1,      -1,    SchemeWsNorm,     SchemeWsVisible,  SchemeWsSel,      SchemeWsOcc,      "",   "1",   "1", },
...
static const char *spcmd_grave[]        = {"`", "st", "-n", "spterm (`)", NULL };
static const char *spcmd_y[]            = {"y", "st", "-n", "spfm (y)", "-e", "yazi", NULL };
...
/* dmenu menus */
static const char *clipboard[]          = { "~/.local/bin/clipboard-menu", NULL };
static const char *apps[]               = { "~/.local/bin/favorite-apps", NULL };
static const char *kblayout[]           = { "~/.local/bin/kblayout-menu", NULL };
static const char *screenshots[]        = { "~/.local/bin/screenshot-menu", NULL };
static const char *power[]              = { "~/.local/bin/power-menu", NULL };
static const char *btmenu[]             = { "~/.local/bin/bt-menu", NULL };
static const char *displays[]           = { "~/.local/bin/autorandr-menu", NULL };
static const char *scratchpads[]        = { "~/.local/bin/scratchpads-menu", NULL };
/* media functions */
static const char *upvol[]              = { "~/.local/bin/volume-manager", "up", NULL };
static const char *downvol[]            = { "~/.local/bin/volume-manager", "down", NULL };
static const char *mutevol[]            = { "~/.local/bin/volume-manager", "mute", NULL };
...
static Key keys[] = {
	...
	{ KeyPress,   MODKEY|Ctrl,                  XK_Return,       riospawn,               {.v = termcmd } }, // draw/spawn a terminal
...
//	STACKKEYS(AltGr|Shift,                                       stackswap)                            // swap the currently focused client with the nth client in the stack
    ...
    // PERSONAL
	{ KeyPress,   MODKEY,                       XK_Return,                               zoom,                   {0} }, // moves the currently focused window to/from the master area (for tiled layouts)
	{ KeyPress,   MODKEY,                       XK_Tab,                                  togglews,               {0} }, // Toggle to the previously viewed workspace on the current monitor
	{ KeyPress,   MODKEY|Shift,                 XK_c,                                    killclient,             {0} }, // close the currently focused window
	...
	{ KeyPress,   0,                            XF86XK_AudioNext,                        spawn,                  {.v = playernext } } ,
	{ KeyPress,   0,                            XF86XK_AudioPrev,                        spawn,                  {.v = playerprev } },
	{ KeyPress,   0,                            XF86XK_AudioPlay,                        spawn,                  {.v = playertoggle } },
	{ KeyPress,   Ctrl|Alt,                     XK_h,                                    spawn,                  {.v = clipboard } },
	{ KeyPress,   MODKEY|Shift,                 XK_p,                                    spawn,                  {.v = apps } },
	{ KeyPress,   0,                            XK_Print,                                spawn,                  {.v = screenshots } },
	{ KeyPress,   Ctrl|Alt,                     XK_space,                                spawn,                  {.v = kblayout } },
	{ KeyPress,   Ctrl|Alt,                     XK_x,                                    spawn,                  {.v = power } },
	{ KeyPress,   Ctrl|Alt,                     XK_l,                                    spawn,                  {.v = lockscreen } },
	{ KeyPress,   Ctrl|Alt,                     XK_t,                                    spawn,                  {.v = btmenu } },
	{ KeyPress,   Alt|Ctrl,                     XK_p,                                    spawn,                  {.v = displays } },
	{ KeyPress,   Alt|Ctrl,                     XK_s,                                    spawn,                  {.v = scratchpads } },
	// END PERSONAL
	SCRATCHKEYS(MODKEY,                         XK_w,            spcmd_w)
	SCRATCHKEYS(MODKEY,                         XK_e,            spcmd_e)
	SCRATCHKEYS(MODKEY,                         XK_grave,        spcmd_grave)
